...
namespace MiniXauonre.Core.Heroes
{
    class Geneva : HeroWithBaseSkills
    {
        ...
        public const double BeamRegen = 40;
        public const double BeamRegenApScale = 0.3;
        public const double BeamCD = 6;
        ...
        public const double ImpulseApScale = 0.4;
        public const double ImpulseSlow = 0.4;
        ...
        public const double ImpulseCost = 140;
